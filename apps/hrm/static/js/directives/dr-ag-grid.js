...
(function (libs_directives) {
    libs_directives._module.directive('bAgGrid', ["$parse","$filter", function ($parse,$filter) {

        return {
        restrict: "CEA",
        replace: true,
        transclude:true,
        template:"<div><div id='grid'></div><div  ng-transclude style='display:none' id='configs'></div></div>" ,
