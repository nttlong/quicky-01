(function (scope) {
    ...
    scope.tableFields = [
        { "data": "profession_code", "title": "${get_res('profession_code','Mã Nghề')}" },
        { "data": "profession_name", "title": "${get_res('profession_name','Tên Nghề')}" },
        { "data": "profession_name2", "title": "${get_res('profession_name2','Tên Nghề Khác')}" },
        { "data": "field_code", "title": "${get_res('field_code','Lĩnh Vực')}" },
