...
def get_list_with_searchtext(args):
    ...
    if (where != None):
        ret.match("(exam_temp_category==@exam_temp_category)", exam_temp_category=where['exam_temp_category'])
    if (sort != None):
        ret.sort(sort)
...
def set_dict_insert_data(args):
    ...
    ret_dict.update(
        ...
        exam_temp_category=(lambda x: x['exam_temp_category'] if x.has_key('exam_temp_category') else None)(
            args['data']),
