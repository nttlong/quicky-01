﻿(function (scope) {
   /* scope.$partialpage = "partialpage/examination_management_template_exam_list";
    ...
    scope.viewDetailsLearningMaterial = function () {
        scope.$root.viewDetailsLearningMaterial();
    }

    scope.viewHistoryLearningMaterial = function () {
        scope.$root.viewHistoryLearningMaterial();
    }
    scope.viewShareFileLearningMaterial = function () {
        scope.$root.viewShareFileLearningMaterial();
    }

    scope.downLoadFileLearningMaterial = function () {
        scope.$root.downLoadFileLearningMaterial();
    }

    //   scope.viewPermisitonLearningMaterial = function () {
    //       scope.$root.viewPermisitonLearningMaterial();
    //}

    scope.viewPermissionLearningMaterialManagerment = function () {
        scope.$root.viewPermissionLearningMaterialManagerment();
    }
    scope.viewAdvandceSearchLearningMaterialManagerment = function () {
        scope.$root.viewAdvandceSearchLearningMaterialManagerment();
    }
