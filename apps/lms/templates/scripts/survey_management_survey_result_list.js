(function (scope) {
    ...
    scope.tableFields = [{
        ...
        {
            "data": "class_name",
            "title": "${get_res('class_name','Class Name')}",
            "className": "text-left"
        },
        {
            "data": "start_date",
            "title": "${get_res('start_date','Start Date')}",
            "className": "text-left"
        },
        {
            "data": "end_date",
            "title": "${get_res('end_date','End Date')}",
            "className": "text-left"
        },
        {
            "data": "by_student",
            "title": "${get_res('by_student','By Student')}",
            "className": "text-left",
            "expr": function (row, data, func) {
                func(function () {
                    return "<span style='color: #EA3D9B;font-weight: bold;'>" + row.by_student;
        ...
        {
            "data": "by_teachers",
            "title": "${get_res('by_teachers','By Teachers')}",
            "className": "text-left",
            "expr": function (row, data, func) {
                func(function () {
                    return "<span style='color: #39B92E;font-weight: bold;'>" + row.by_teachers;
        ...
        {
            "data": "by_training_dept",
            "title": "${get_res('by_training_dept','By Training Dept')}",
            "className": "text-left",
            "expr": function (row, data, func) {
                func(function () {
                    if (row.by_training_dept == "Done") {
                        return "<span style='color: #FF903F;font-weight: bold;'>" + row.by_training_dept;
                    } else {
                        return "<span style='color: #4068FF;font-weight: bold;'>" + row.by_training_dept;
                    }
    ...
    function previousRow() {
        if (scope.__tableSource.length > 0) {
            var idx_item = _.findIndex(scope.__tableSource, {
                "employee_code": scope.currentItem.employee_code
            });
        ...
        sort[orderBy[0].columns] =
            ...
            .then(function (res) {
                var dataTest = [{
                    id: "001",
                    class_name: "Name 0",
                    start_date: "20.1.2018",
                    end_date: "20.2.2018",
                    by_student: "15/20",
                    by_teachers: "3/5",
                    by_training_dept: "Done",
                }, {
                    id: "002",
                    class_name: "Name 0",
                    start_date: "20.1.2018",
