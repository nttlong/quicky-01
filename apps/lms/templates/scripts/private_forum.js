(function (scope) {
    ...
    scope.tableFields = [
            ...
            { "data": "forum_info.course_name", "title": "${get_res('course_name','Course Name')}","format": "date:" + 'dd/MM/yyyy'  },
            ...
            { "data": "created_on", "title": "${get_res('forum_created_on','Create At')}", "format": "date:" + 'dd/MM/yyyy h:mm:ss a' },
    ];
    ...
    function _tableData(iPage, iPageLength, orderBy, searchText, callback) {
        ...
        sort[orderBy[0].columns] =
            services.api("${get_api_key('app_main.api.LMSLS_Forum/get_list_with_searchtext_private')}")
                .data({
                    //parameter at here
                    "pageIndex": iPage - 1,
