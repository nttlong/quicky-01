(function (scope) {
    scope.$$tableTree = {
        "dataTableTree": [],
        "tableFields" : [
            { "data": "train_group_code", "title": "${get_res('train_group_code','Mã nhóm')}", width: "100px"},
            { "data": "train_group_name2", "title": "${get_res('train_group_name2','Tên khác')}", width: "100px"},
            //{ "data": "parent_code", "title": "${get_res('parent_code','Nhóm cha')}", width: "100px", className: "text-center"},
            { "data": "display_parent_code", "title": "${get_res('parent_code','Nhóm cha')}", width: "100px"},
    ...
    scope._reloadpage = _trainCourseGroup;
    //enter-press in row

    // reload data
    function _trainCourseGroup() {
    ...
    function onAdd() {
            scope.mode = 1;
            openDialog("${get_res('Train_Course_Group_Detail','Chi tiết nhóm đào tạo')}", 'form/addTrainCourseGroup', function () {
            setTimeout(function () {
    ...
    debugger
        ...
        else
        {
            ...
            $msg.confirm("${get_global_res('Notification','Thông báo')}", "${get_global_res('Do_You_Want_Delete','Bạn có muốn xóa không?')}", function () {
                services.api("${get_api_key('app_main.api.HCSLS_TrainCourseGroup/delete')}")
    ...
    function onEdit() {
            scope.mode = 2;
            openDialog("${get_res('Factor_Appraisal_Group_Detail','Chi tiết nhóm đào tạo')}", 'form/addTrainCourseGroup', function () { });
    };
