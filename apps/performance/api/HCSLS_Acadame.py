        ...
        if args['data'] != None:
            if args['data'].has_key('_id') or args['data'].has_key('train_level_code'):
                ...
                if check_exist == None:
                    ...
                    ret  = qmongo.models.HCSLS_Acadame.insert(data)
                    lock.release()
                    return ret
                else:
                    update(args)
...
def update(args):
    try:
        ...
        if args['data'] != None:
            ...
            ret  = qmongo.models.HCSLS_Acadame.update(
                data, 
                "train_level_code == {0}", 
...
def delete(args):
    try:
        ...
        ret = {}
        if args['data'] != None:
            ret  =  qmongo.models.HCSLS_Acadame.delete("train_level_code in {0}",[x["train_level_code"]for x in args['data']])
            lock.release()
            return ret
