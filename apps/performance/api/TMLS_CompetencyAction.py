...
def get_list_with_searchtext(args):
    ...
    ret=models.TMLS_CompetencyAction().aggregate()
...
def insert(args):
    try:
        ...
        if args['data'] != None:
            del args['data']['_id']
            ret  =  models.TMLS_CompetencyAction().insert(args['data'])
            lock.release()
            return ret
...
def update(args):
    try:
        ...
        if args['data'] != None:
            ...
            del data['_id']
            ret  =  models.TMLS_CompetencyAction().update(
                data,
...
def delete(args):
    try:
        ...
        ret = {}
        if args['data'] != None:
            ret  =  models.TMLS_CompetencyAction().delete(
