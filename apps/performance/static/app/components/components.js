...
.run(['$templateCache', function ($templateCache) {
    ...
    $templateCache.put('app/components/input/datepicker/datepicker.html', '<span class="input-group zb-form-date-picker"><input type="text" class="form-control" uib-datepicker-popup="{{format}}" datepicker-options="options" ng-model="dt" is-open="opened" close-text="Close" alt-input-formats="altInputFormats" show-button-bar="true" placeholder="{{placeholder}}"><span class="input-group-btn"><button type="button" class="btn btn-default"><i class="bowtie-icon bowtie-calendar"></i></button></span></span>');
