(function () {
    ...
    angular.module('ZebraApp.widgets')
        .directive('bottomPage', ["$compile", "templateService", "authenticatedService", headerPage]);
    ...
    function headerPage($compile, templateService, authenticatedService) {
        return {
            ...
            templateUrl: templateService.getStatic("app/widgets/header-page/bottom-page.html"),
