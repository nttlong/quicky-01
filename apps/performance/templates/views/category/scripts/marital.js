(function (scope) {
    ...
    scope.tableFields = [
        { "data": "marital_code", "title": "${get_res('marital_code_table_header','Mã')}", "className": "text-left", width: "170px" },
        { "data": "marital_name", "title": "${get_res('marital_name_table_header','Tên')}", "className": "text-left" },
