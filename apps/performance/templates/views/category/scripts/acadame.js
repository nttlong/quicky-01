(function (scope) {
    ...
    scope.tableFields = [
        { "data": "train_level_code", "title": "${get_res('train_level_code_table_header','Mã')}", "className": "text-left" },
        { "data": "train_level_name", "title": "${get_res('train_level_code_table_header','Tên')}", "className": "text-left" },
    ...
    scope.$parent.$parent.$watch("advancedSearch.data_lock", function (val) {
