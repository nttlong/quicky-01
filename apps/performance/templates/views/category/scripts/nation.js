(function (scope) {
    ...
    scope.tableFields = [
        { "data": "nation_code", "title": "${get_res('nation_code_table_header','Mã')}", "className": "text-left", width: "170px" },
        { "data": "nation_name", "title": "${get_res('nation_name_table_header','Tên')}", "className": "text-left" },
