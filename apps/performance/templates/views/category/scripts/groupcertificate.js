(function (scope) {
    ...
    scope.tableFields = [
        { "data": "group_cer_code", "title": "${get_res('group_cer_code_table_header','Mã')}", "className": "text-left", width: "170px" },
        { "data": "group_cer_name", "title": "${get_res('group_cer_name_table_header','Tên')}", "className": "text-left" },
