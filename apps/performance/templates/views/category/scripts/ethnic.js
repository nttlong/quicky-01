(function (scope) {
    ...
    scope.tableFields = [
        { "data": "ethnic_code", "title": "${get_res('ethnic_code_table_header','Mã')}", "className": "text-left", width: "170px" },
        { "data": "ethnic_name", "title": "${get_res('ethnic_name_table_header','Tên')}", "className": "text-left" },
