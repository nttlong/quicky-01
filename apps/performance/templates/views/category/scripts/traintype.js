(function (scope) {
    ...
    scope.tableFields = [
        { "data": "train_mode_code", "title": "${get_res('train_mode_code_table_header','Mã')}", "className": "text-left", width: "170px" },
        { "data": "train_mode_name", "title": "${get_res('train_mode_name_table_header','Tên')}", "className": "text-left" },
