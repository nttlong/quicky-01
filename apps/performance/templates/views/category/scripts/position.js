(function (scope) {
    ...
    scope.tableFields = [
        { "data": "job_pos_code", "title": "${get_res('job_pos_code_table_header','Mã')}", "className": "text-left", width: "170px" },
        { "data": "job_pos_name", "title": "${get_res('job_pos_name_table_header','Tên')}", "className": "text-left" },
