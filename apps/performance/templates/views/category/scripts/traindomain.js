(function (scope) {
    ...
    scope.tableFields = [
        { "data": "domain_code", "title": "${get_res('domain_code_table_header','Mã')}", "className": "text-left", width: "170px" },
        { "data": "domain_name", "title": "${get_res('domain_name_table_header','Tên')}", "className": "text-left" },
