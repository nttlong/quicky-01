(function (scope) {
    ...
    scope.tableFields = [
        { "data": "religion_code", "title": "${get_res('religion_code_table_header','Mã')}", "className": "text-left", width: "170px" },
        { "data": "religion_name", "title": "${get_res('religion_name_table_header','Tên')}", "className": "text-left" },
