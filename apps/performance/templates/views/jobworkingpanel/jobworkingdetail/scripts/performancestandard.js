(function (scope) {
    scope.$$table = {
        tableFields: [
            ...
            { "data": "weight", "title": "${get_res('weight_table_header','Trọng số')}","format":"number: system","width":"100px" },
            { "data": "score_from", "title": "${get_res('score_from_table_header','Cho điểm từ')}","format":"number","width":"100px" },
            { "data": "score_to", "title": "${get_res('score_to_table_header','đến')}","format":"number: system","width":"100px" }
        ],
        $$tableConfig: {},
    ...
    function _tableData(iPage, iPageLength, orderBy, searchText, callback) {
        ...
        sort[orderBy[0].columns] =
            services.api("${get_api_key('app_main.api.HCSLS_JobWorking/get_list_performance_standanrd')}")
                .data({
                    //parameter at here
                    "pageIndex": iPage - 1,
