(function (scope) {
    scope.$$tableTree = {
        "dataTableTree": [],
        "tableFields": [
            { "data": "factor_group_code", "title": "${get_res('function_list','Bộ phận')}", width: "100px", className: "text-center" },
            { "data": "note", "title": "${get_res('note','Mã')}", width: "100px", className: "text-center" },
